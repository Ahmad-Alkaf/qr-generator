...
export const metadata: Metadata = {
  title: "Log In",
  description: "Sign in to your QRForge account to manage QR codes, view analytics, and more.",
    ...
    <div className="flex min-h-[70vh] items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="mt-8 space-y-3">
          {/* OAuth buttons (will be wired to NextAuth in Phase 2) */}
          <button
            type="button"
            className="flex w-full items-center justify-center gap-3 rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow-sm transition-colors hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
          >
